...
./gradlew build
```
It produces the `lessons-1.0.0-runner.jar` file in the `/build` directory.
...
The application is now runnable using `java -jar build/lessons-1.0.0-runner.jar`.
...
You can then execute your native executable with: `./build/lessons-1.0.0-runner`
